...
<link rel="stylesheet" href="/resources/hj/css/adminFreeView.css">
...
<body>
	                    ...
	                    <c:if test="${list.size() != 0}">
		                    <c:forEach var="dto" items="${list }">
		                    	<li class="list_group_item">
			                        ...
			                        <div class="title"><a id="titleA" href="/adminFreeView/${dto.bno }?pg=${paging.page}&range=${paging.range}"><c:out value="${dto.title}" /></a></div>                        
				...
				<div id="paginationBox">
					...
					<ul class="pagination">
						<c:if test="${paging.first}">
							<li class="page-item"><a class="page-link" href="#" onClick="location.href='/adminFreeView?pg=1&range=1&searchType=${search.searchType }&keyword=${search.keyword }'">《</a></li>
						</c:if>
    ...
    <c:url var="adminFreeViewURL" value="/adminFreeView"></c:url>
...
function fn_prev(page, range, rangeSize, searchType, keyword) {
	...
	var range = range - 1;
	var url = "${pageContext.request.contextPath}/adminFreeView";
	url = url + "?pg=" + page;
	url = url + "&range=" + range;
