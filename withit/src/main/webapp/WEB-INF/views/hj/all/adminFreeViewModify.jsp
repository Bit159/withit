...
<head>
	...
	<link rel="stylesheet" href="/resources/hj/css/adminFreeViewModify.css">
         	...
         	<div id="boardModifyWrapper">
		        <div id="boardModifyContainer">
		            ...
		            <div id="boardModifyButton">
		                ...
		                <button type="button" id="boardListBtn" onclick="location.href='/adminFreeView'">글 목록</button>
		            </div>
		        </div>
		    </div>
	    	...
	    	success: function(){
	    		Swal.fire(
						  ...
						  'success'
							...
							location.href='/adminFreeView/'+bno;
			    		});;
	    	},
	    	error: function(err){
				console.log(err);
